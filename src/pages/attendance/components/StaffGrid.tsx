      ...
      {staff.map((member) => (
        <div
          ...
          className={cn(
            ...
            member.status === "present" && "border-green-200 bg-green-50",
            member.status === "absent" && "border-red-200 bg-red-50",
            member.status === "late" && "border-amber-200 bg-amber-50",
            member.status === "leave" && "border-purple-200 bg-purple-50",
            !member.status && "border-gray-200"
          )}
        >
          <div className="flex flex-col items-center text-center">
            <div className="mb-1 font-semibold">{member.name}</div>
            <div className="text-sm text-gray-600 mb-1">{member.designation}</div>
            <div className="text-xs text-gray-500 mb-4">ID: {member.employeeId}</div>
